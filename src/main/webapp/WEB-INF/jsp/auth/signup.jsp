					...
					<div
						...
						<div class="card card-plain">
							<div class="card-header">
								...
								<p class="mb-0">Enter your email and password to register
								</p>
							</div>
							<div class="card-body">
								<form role="form" action="/signup" method="POST">
									<div class="input-group input-group-outline mb-3">
										<label class="form-label">Username</label> <input
											...
											pattern=".*\..*"
											title="Le username doit �tre sous forme username.username minimum 8 characters by one"
											required>
									</div>
									<div class="input-group input-group-outline mb-3">
										<label class="form-label">Password</label> <input required
											...
											title="Minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character, A � Z et a � z et 0 � 9 et @$!%*?&">
									</div>
									<div class="input-group input-group-outline mb-3">
