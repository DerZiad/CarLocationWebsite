...
<layout:extends name="base.jsp">
					...
					<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"
						...
						<div class="ms-md-auto pe-md-3 d-flex align-items-center">
							<div class="input-group input-group-outline">
								<label class="form-label">Type here...</label> <input
	...
	<layout:put block="scriptsfiles" type="REPLACE">
		...
		<script>
			...
			var ctx3 = document.getElementById("chart-line-tasks").getContext(
					"2d");
	...
	<layout:put block="scriptsfiles" type="REPLACE">
		...
		<link
			...
			rel="stylesheet">
		<link id="pagestyle"
			href="./assets/css/material-dashboard.css?v=3.0.0" rel="stylesheet" />
	</layout:put>
</layout:extends>