                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input value="${user.username}" name="username" id="username" class="form-control" pattern=".*\..*" title="Le username doit être sous forme username.username minimum 8 characters by one" />
                        </div>
                        <p style="color: red;">
                    ...
                    <c:forEach var="manager" items="${managers}">
                        <tr>
                            ...
                            <c:if test="${manager.enabled}">
                                <td>
                                    <a href="/admin/manager/ban/${manager.id}" class="delete">
